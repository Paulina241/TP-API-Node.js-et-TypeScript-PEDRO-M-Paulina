...
// Importation des contrôleurs qui gèrent la logique métier pour les utilisateur
import { getUsers, addUser, getUserById, deleteUser, updateUser } from '../controllers/user.controllers';
